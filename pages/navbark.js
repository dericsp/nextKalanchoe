...
function NavMenu() {
  ...
  return (
    <div>
      ...
      <Link href="https://api.whatsapp.com/send?phone=5511998305337&amp;text=Gostaria%20de%20obter%20maiores%20informações%20sobre%20a%20revenda%20de%20mercadoria%20em%20consignado."><a className='whats' target='_blank' rel='noopener noreferrer'><Image id='whats' src='/whatsapp.png' alt='logotipo whatsapp' width={90} height={90} /></a></Link>
