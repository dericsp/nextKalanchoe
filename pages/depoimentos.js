    ...
    return (
		...
		<div className="row">
			<div className="span12">
				<img className="depoimentos" src="/helena.png" alt="kalanchoê foto revendedora Helena Franco" />
				...
				<br/>
				<p className="assinatura">Helena Franco da Cunha, 66 anos. Mogi das Cruzes</p>
			</div>
		</div>
		<div className="row">
			<div className="span12">
				<img className="depoimentos" src="/cleide.png" alt="kalanchoê foto revendedora Maria Cleide" />
				<p className="paragrafo">
				...
				<p className="assinatura">Maria Cleide da Silva, 39 anos. São José dos Campos.</p>
			</div>
		</div>
		<div className="row">
			<div className="span12">
				<img className="depoimentos" src="/danubia.png" alt="kalanchoê foto revendedora Danubia Katia" />
				<p className="paragrafo">Olá meninas, estou aqui para falar um pouco da empresa a qual eu tenho orgulho em fazer parte. Trabalho com a Kalanchoê desde 2013, amo o que faço e também a mercadoria que vendo, essa venda tem sido a minha renda familiar pois com minhas comissões consigo ajudar nas despesas familiares. Uma empresa honesta, com produtos de qualidade onde você consegue fazer os seus horários e seus dias de trabalho.</p>
				<p className="assinatura">Danubia Katia Silva, 34 anos. Mogi das Cruzes</p>
			</div>
		</div>
