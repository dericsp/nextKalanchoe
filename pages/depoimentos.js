...
function DepoimentosVendedoras() {
    return (
		...
		<CardGroup>
		<Card>
				<Card.Img variant='top'src="/helena.png" alt="kalanchoê foto revendedora Helena Franco" />
		...
		<Card>
				<Card.Img variant='top' src="/cleide.png" alt="kalanchoê foto revendedora Maria Cleide"  />
				<Card.Text className='textos'>
		...
		<Card>
				<Card.Img variant='top' src="/danubia.png" alt="kalanchoê foto revendedora Danubia Katia" />
