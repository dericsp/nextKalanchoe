...
function DepoimentosVendedoras() {
    return (
		...
		<Row>
			<Col>
		<Media>
				<Image src="/helena.png" alt="kalanchoê foto revendedora Helena Franco" width={84} height={84}/>
				<Media.Body>
		...
		<Media>
				<Image src="/cleide.png" alt="kalanchoê foto revendedora Maria Cleide" width={84} height={84} />
				<Media.Body>
		...
		<Media>
				<Image src="/danubia.png" alt="kalanchoê foto revendedora Danubia Katia" width={84} height={84}/>
				<Media.Body>
